        ...
        <div className="relative z-10">
                ...
                {faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown 
                        className={`w-6 h-6 text-blue-400 faq-icon shrink-0 ${
                          openFaq === index ? "open" : ""
                        }`} 
                      />
                    </button>
          ...
          <div ref={ctaRef} className="py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="absolute inset-0 bg-linear-to-br from-blue-600/10 via-purple-600/5 to-indigo-600/10"></div>
