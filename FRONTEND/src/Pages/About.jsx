...
const About = () => {
  ...
  return (
    <div className="relative min-h-screen bg-linear-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
      {/* Particle Background */}
      <div 
        ref={particlesRef}
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-20 left-10 w-48 h-48 md:w-96 md:h-96 bg-linear-to-r from-white/5 to-gray-300/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-40 h-40 md:w-80 md:h-80 bg-linear-to-r from-gray-400/8 to-white/8 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-1/3 w-36 h-36 md:w-72 md:h-72 bg-linear-to-r from-white/6 to-gray-500/6 rounded-full blur-3xl animate-pulse delay-2000"></div>
        <div className="absolute top-1/2 right-10 w-32 h-32 md:w-64 md:h-64 bg-linear-to-r from-gray-300/7 to-white/7 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 px-4 py-12 md:py-20 lg:px-20 space-y-16 md:space-y-24 lg:space-y-32">
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-3xl md:text-5xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent mb-4 md:mb-6 lg:mb-8 tracking-tight animate-fade-in pt-16">
              About the Project
            </h2>
            <div className="w-20 h-1 md:w-32 md:h-2 lg:w-40 bg-linear-to-r from-white to-gray-400 mx-auto rounded-full shadow-lg md:shadow-2xl shadow-white/30 animate-pulse"></div>
          </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl md:rounded-3xl border border-white/30 p-4 sm:p-6 md:p-10 lg:p-16 shadow-xl md:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:shadow-white/20 hover:border-white/40 group hover:transform hover:scale-[1.02]">
            <div className="space-y-6 md:space-y-8 lg:space-y-10">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-6 mb-4 md:mb-6 lg:mb-8">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-linear-to-r from-white to-gray-300 rounded-xl md:rounded-2xl lg:rounded-3xl flex items-center justify-center text-xl sm:text-2xl md:text-3xl lg:text-3xl shadow-lg md:shadow-2xl text-black">
                  🚀
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mt-8 md:mt-12 lg:mt-16">
                <div className="space-y-4 md:space-y-6 lg:space-y-8">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-6">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-linear-to-r from-gray-300 to-white rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center text-lg sm:text-xl md:text-2xl lg:text-3xl shadow-lg md:shadow-2xl text-black">
                      🎯
                    </div>
                  ...
                  <ul className="space-y-3 md:space-y-4 lg:space-y-6 text-gray-100 ml-0 sm:ml-12 md:ml-16 lg:ml-20 text-sm sm:text-base md:text-base lg:text-lg">
                    <li className="flex items-start gap-2 md:gap-3 lg:gap-4">
                      <div className="w-1 h-1 md:w-2 md:h-2 bg-gray-300 rounded-full mt-1 md:mt-1 shrink-0 shadow-sm md:shadow-lg shadow-gray-300/50"></div>
                ...
                <div className="space-y-4 md:space-y-6 lg:space-y-8">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-6">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-linear-to-r from-gray-400 to-gray-200 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center text-lg sm:text-xl md:text-2xl lg:text-3xl shadow-lg md:shadow-2xl text-black">
                      👨‍💻
                    </div>
                    <h4 className="text-lg sm:text-xl md:text-xl lg:text-2xl text-gray-200 font-bold">
                      Target Users
              ...
              <div className="mt-8 md:mt-12 lg:mt-16 p-4 sm:p-6 md:p-8 lg:p-10 bg-linear-to-r from-gray-800/40 to-black/40 rounded-xl md:rounded-2xl lg:rounded-3xl border border-gray-600/40 backdrop-blur-sm hover:bg-gray-700/40 transition-all duration-500">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-6 mb-3 md:mb-4 lg:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-linear-to-r from-white to-gray-300 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center text-lg sm:text-xl md:text-2xl lg:text-3xl shadow-lg md:shadow-2xl text-black">
                    🧠
                  </div>
              ...
              <div className="mt-6 md:mt-8 lg:mt-10 p-4 sm:p-6 md:p-8 lg:p-10 bg-linear-to-r from-black/40 to-gray-800/40 rounded-xl md:rounded-2xl lg:rounded-3xl border border-gray-500/40 backdrop-blur-sm hover:bg-gray-700/40 transition-all duration-500">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-6 mb-3 md:mb-4 lg:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-linear-to-r from-gray-400 to-white rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center text-lg sm:text-xl md:text-2xl lg:text-3xl shadow-lg md:shadow-2xl text-black">
                    🌐
                  </div>
                  <h4 className="text-lg sm:text-xl md:text-xl lg:text-2xl text-white font-bold">
                    Vision
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-gray-400 to-white bg-clip-text text-transparent mb-3 md:mb-4 lg:mb-6 tracking-tight">
              Our Motive
            </h2>
            <div className="w-18 h-1 md:w-28 md:h-2 lg:w-36 bg-linear-to-r from-gray-400 to-white mx-auto rounded-full shadow-lg md:shadow-2xl shadow-gray-400/50"></div>
          </div>
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="w-18 h-1 md:w-28 md:h-2 lg:w-36 bg-linear-to-r from-white to-gray-400 mx-auto rounded-full shadow-lg md:shadow-2xl shadow-white/50"></div>
          </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl md:rounded-3xl border border-white/30 p-4 sm:p-6 md:p-10 lg:p-16 shadow-xl md:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:border-white/40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
              {[
                ...
                <div key={index} className="p-4 sm:p-6 md:p-8 lg:p-10 bg-linear-to-br from-black/20 to-gray-800/20 backdrop-blur-sm rounded-xl md:rounded-2xl lg:rounded-3xl border border-gray-600/40 hover:border-gray-400/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-xl md:hover:shadow-2xl group">
                  <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 md:gap-8">
                    <div className="text-2xl sm:text-3xl md:text-4xl shrink-0 group-hover:scale-110 md:group-hover:scale-125 transition-transform duration-300">{item.icon}</div>
                    <div>
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-gray-300 to-white bg-clip-text text-transparent mb-3 md:mb-4 lg:mb-6 tracking-tight">
              Scope of the Application
            </h2>
            <div className="w-18 h-1 md:w-28 md:h-2 lg:w-36 bg-linear-to-r from-gray-300 to-white mx-auto rounded-full shadow-lg md:shadow-2xl shadow-gray-300/50"></div>
          </div>
        ...
        <section className="max-w-6xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-11 md:mb-14 lg:mb-16">
            <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-white to-gray-300 bg-clip-text text-transparent mb-3 md:mb-4 lg:mb-6 tracking-tight">
              Platform Features
            </h2>
            <div className="w-18 h-1 md:w-28 md:h-2 lg:w-36 bg-linear-to-r from-white to-gray-300 mx-auto rounded-full shadow-lg md:shadow-2xl shadow-white/50"></div>
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
            {[
              ...
              { name: "Khushi Singh", role: "Frontend Developer", image: st1, quote: "I designed the platform with accessibility and simplicity in mind. " },
              ...
              <div key={index} className="backdrop-blur-xl bg-white/10 border border-white/30 hover:bg-white/15 transition-all duration-700 hover:transform hover:scale-105 shadow-xl md:shadow-2xl rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 text-center hover:border-white/40 group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-linear-to-r from-white to-gray-300 rounded-full mx-auto mb-4 md:mb-6 lg:mb-8 p-1 shadow-lg md:shadow-2xl">
                  <img 
                    src={member.image} 
                    alt={member.name}
