...
const Contact = () => {
  ...
  return (
    <section className="relative min-h-screen bg-linear-to-br from-slate-950 via-gray-900 to-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-40 -right-40 w-150 h-150 bg-blue-600/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="absolute inset-0 bg-linear-to-t from-blue-950/20 via-transparent to-blue-950/10"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-20 space-y-4 sm:space-y-6 pt-16">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-blue-500/20 to-blue-600/20 backdrop-blur-xl rounded-2xl mb-4 sm:mb-6 animate-bounce-slow border border-blue-400/20 ">
            <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400" />
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold bg-linear-to-r from-white via-blue-200 to-blue-300 bg-clip-text text-transparent mb-4 sm:mb-6 animate-gradient-x leading-tight px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-8 sm:mb-12 lg:mb-20 px-4 sm:px-0">
          {[
            ...
            <div
              key={index}
              className="group relative bg-linear-to-br from-blue-500/10 to-blue-600/10 backdrop-blur-xl border border-blue-400/20 rounded-2xl p-4 sm:p-6 hover:bg-linear-to-br hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 cursor-pointer"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-r from-blue-500 to-blue-600 rounded-xl mb-3 sm:mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
              ...
              <div className="absolute inset-0 bg-linear-to-r from-blue-400/5 to-transparent opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300"></div>
            </div>
          ))}
        </div>
          ...
          <div className="relative">
            <div className="bg-blue-500/5 backdrop-blur-xl border border-blue-400/20 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2 sm:mb-3 bg-linear-to-r from-white to-blue-200 bg-clip-text ">
                  Send Your Message
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {formStatus === 'success' && (
                  <div className="text-center p-3 sm:p-4 bg-linear-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/20 rounded-xl text-blue-400 animate-fadeInUp backdrop-blur-xl">
                ...
                {formStatus === 'error' && (
                  <div className="text-center p-3 sm:p-4 bg-linear-to-r from-red-500/10 to-red-600/10 border border-red-500/20 rounded-xl text-red-400 animate-fadeInUp backdrop-blur-xl">
                    <div className="flex items-center justify-center space-x-2">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className={`absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-blue-600/20 opacity-0 transition-opacity duration-300 pointer-events-none ${focusedField === 'name' ? 'opacity-100' : ''}`}></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 bg-blue-500/5 border border-blue-400/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 hover:bg-blue-500/10 backdrop-blur-xl text-sm sm:text-base"
                    />
                    <div className={`absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-blue-600/20 opacity-0 transition-opacity duration-300 pointer-events-none ${focusedField === 'email' ? 'opacity-100' : ''}`}></div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 bg-blue-500/5 border border-blue-400/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 hover:bg-blue-500/10 backdrop-blur-xl text-sm sm:text-base"
                      />
                      <div className={`absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-blue-600/20 opacity-0 transition-opacity duration-300 pointer-events-none ${focusedField === 'mobile' ? 'opacity-100' : ''}`}></div>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <div className={`absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-blue-600/20 opacity-0 transition-opacity duration-300 pointer-events-none ${focusedField === 'gender' ? 'opacity-100' : ''}`}></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className={`absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-blue-600/20 opacity-0 transition-opacity duration-300 pointer-events-none ${focusedField === 'message' ? 'opacity-100' : ''}`}></div>
                  </div>
                </div>
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="bg-blue-500/5 backdrop-blur-xl border border-blue-400/20 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:scale-[1.02]">
              <div className="text-center mb-4 sm:mb-6">
                <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-linear-to-r from-blue-500 to-blue-600 rounded-2xl mb-3 sm:mb-4 shadow-lg">
                  <MapPin className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2 sm:mb-3 bg-linear-to-r from-white to-blue-200 bg-clip-text ">
                  Visit Our Office
                </h3>
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-linear-to-r from-blue-500/20 to-blue-600/20 rounded-3xl blur opacity-50 group-hover:opacity-75 transition-opacity duration-500 animate-pulse-slow"></div>
              <div className="relative bg-blue-500/5 backdrop-blur-xl border border-blue-400/20 rounded-3xl p-2 sm:p-3 shadow-2xl overflow-hidden">
                ...
                {/* Map Overlay */}
                <div className="absolute inset-0 bg-linear-to-t from-black/20 via-transparent to-transparent rounded-2xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
            </div>
